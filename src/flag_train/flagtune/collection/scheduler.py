...
Environment variables:
    ...
    tokens; each spawned worker receives exactly one selected token. ``FLAGTRAIN_DB_URL``
...
def _prepare_tasks(
    ...
    from flag_train.flagtune.contracts.operator import load_operator_benchmark_spec
    from flag_train.flagtune.runtime.executor import prepare_benchmark_case
...
def _run_worker(args: argparse.Namespace) -> int:
    ...
    """
    os.environ["FLAGTRAIN_DB_URL"] = args.database_url
    ...
    from flag_train.flagtune.runtime.executor import (
        BenchmarkWorker,
...
def _worker_environment(
    ...
    Args:
        ...
        database_url: LibTuner database URL bound before importing FlagTrain.
    ...
    env["FLAGTRAIN_DB_URL"] = database_url
    return env
...
def run_shape_config_benchmarks(
    ...
    *,
    ...
    Args:
        ...
        database_url: Optional backend URL; defaults to FlagTrain configuration.
...
def benchmark_shape_configs(
    ...
    temp_root = Path.home() / ".flagtrain" / "benchmark-work"
