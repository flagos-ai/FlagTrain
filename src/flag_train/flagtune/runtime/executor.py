...
FlagTrain metadata, and returns a stable operator-independent result mapping.
...
class BenchmarkWorker:
    """Execute any safely configured public FlagTrain operator on one GPU.
    ...
    def __init__(self, config_path: str, device_runtime: Any = None) -> None:
        ...
        Raises:
            ...
            ImportError: If torch, Triton, or FlagTrain is unavailable.
            AttributeError: If a caller bypassed planning and the configured
                public operator is absent from ``flag_train``.
        ...
        self.operator = resolve_public_operator(flag_train, self.spec.op_id)
    ...
    def _find_tuner(self, variant: str) -> tuple[Any, Any]:
        ...
        Security:
            ...
            imported public FlagTrain callable.
        """
        from flag_train.utils.libentry import find_flagtune_benchmark_target
    ...
    def _invoke(self, tensors: Mapping[str, Any], variant: str) -> Any:
        ...
        Returns:
            The public FlagTrain callable's result without post-processing.
    ...
    def measure_configs(
        ...
        *,
        ...
        from flag_train.utils.libentry import clear_libentry_dispatch_cache
    ...
    def benchmark(
        ...
        *,
        ...
        from flag_train.utils.libentry import (
            LibTunerRunMode,
