...
def _wrap_op_with_precision_check(op_key, fn):
    """Wrap a FlagTrain operator to compare its output against native PyTorch.

    Since FlagTrain replaces the CUDA dispatch, the native implementation
    ...
    def wrapper(*args, **kwargs):
        ...
        # Execute the FlagTrain implementation FIRST with no interference
