...
def cache_dir_path() -> Path:
    """Return the cache directory for generated files in flagtrain."""
    _cache_dir = os.environ.get("FLAGTRAIN_CACHE_DIR")
    if _cache_dir is None:
        _cache_dir = Path.home() / ".flagtrain"
    else:
...
def cache_dir() -> Path:
    """Return cache directory for generated files in flagtrain. Create it if it does not exist."""
