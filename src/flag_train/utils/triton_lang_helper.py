...
from flag_train.runtime import backend
from flag_train.runtime.backend.device_finder import DeviceDetector
...
def _patch_missing_symbols(module, names):
    for name in names:
        ...
        # FlagTrain only needs their shared round-to-nearest-even value semantics.
